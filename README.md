...
`init(modelObject, onValidPin, onInvalidPin)`|Initializing of settings passing settings model object and *optional* *onValidPin / onInvalidPin* functions|initialized settings model object as promise
